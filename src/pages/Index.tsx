...
const IndexContent = () => {
  ...
  useEffect(() => {
    const shortcuts = [
      ...
      { key: 'Ctrl+6', description: 'Go to Monitor', action: () => setActiveView('monitor'), category: 'navigation' as const },
      { key: 'Ctrl+7', description: 'Go to Statistics', action: () => setActiveView('stats'), category: 'navigation' as const },
      { key: 'Ctrl+8', description: 'Go to Settings', action: () => setActiveView('settings'), category: 'navigation' as const },
